      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12 flex-1 space-y-8">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-gray-300 font-sans text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              <strong>Публичные палитры:</strong> База данных Supabase используется исключительно для хранения общедоступных палитр и цветовых схем.
            </p>
            <p>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1.5">
              <li><strong>Supabase:</strong> Облачная база данных (PostgreSQL) для хранения общедоступных палитр.</li>
