      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12 flex-1 space-y-8">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-gray-300 font-sans text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              <strong>Посетители сайта:</strong> Для использования сервиса не требуется указывать адрес электронной почты, пароль, имя или другие идентификационные данные. Рабочее состояние редактора палитр сохраняется исключительно на стороне вашего устройства в локальном хранилище браузера (<code className="text-purple-300 font-mono text-xs">localStorage</code>, ключ <code className="text-purple-300 font-mono text-xs">oklch_studio_state_v1</code>). Эти данные не передаются на сервер.
            </p>
            <p>
              <strong>Публичные палитры и база данных:</strong> Supabase используется для хранения общедоступных палитр и технических данных, необходимых для работы сайта.
            </p>
            <p>
              <strong>Статистика посещаемости:</strong> Сайт использует сервис <code className="text-purple-300 font-mono text-xs">@vercel/analytics</code> (Vercel Analytics) для сбора обобщённых показателей посещаемости (количество просмотров, уникальные посетители, популярные страницы, источники переходов, страна и тип устройства). Vercel Web Analytics работает без использования cookies; идентификация уникального визита строится через временный хэш, который не сохраняется дольше 24 часов, не содержит персональных профилей и не осуществляет трекинг между сторонними сайтами.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1.5">
              <li>Мы не продаём пользовательские данные. Данные могут обрабатываться сторонними инфраструктурными сервисами, необходимыми для работы сайта, включая Supabase и Vercel.</li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1.5">
              <li><strong>Supabase:</strong> Облачная база данных (PostgreSQL) для хранения общедоступных палитр и технических данных, необходимых для работы сайта.</li>
